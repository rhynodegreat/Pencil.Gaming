...
namespace Pencil.Gaming.NanoVG {
    internal static class NanoVG_native {
        ...
        const CharSet set = CharSet.Ansi;
        [DllImport(lib)]
        ...
        [DllImport(lib)]
        internal static extern void nvgStrokeColor(IntPtr ctx, Color4 color);
        [DllImport(lib)]
        internal static extern void nvgStrokePaint(IntPtr ctx, PaintNative paint);
        [DllImport(lib)]
        internal static extern void nvgFillColor(IntPtr ctx, Color4 color);
        [DllImport(lib)]
        ...
        [DllImport(lib)]
        internal static extern void nvgCurrentTransform(IntPtr ctx, IntPtr buffer);

        [DllImport(lib, CharSet = set)]
        ...
        [DllImport(lib)]
        internal static extern PaintNative nvgLinearGradient(IntPtr ctx, float sx, float sy, float ex, float ey, Color4 icol, Color4 ocol);
        [DllImport(lib)]
        internal static extern PaintNative nvgBoxGradient(IntPtr ctx, float x, float y, float w, float h, float r, float f, Color4 icol, Color4 ocol);
        [DllImport(lib)]
        internal static extern PaintNative nvgRadialGradient(IntPtr ctx, float cx, float cy, float inr, float outr, Color4 icol, Color4 ocol);
        [DllImport(lib)]
